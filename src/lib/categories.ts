...
export const categoryNames = Object.values(categories).map(category => category.name);
export const categorySlugs = Object.values(categories).map(category => category.slug);
